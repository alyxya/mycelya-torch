...
class TestTrigonometricOperations:
    ...
    @pytest.mark.fast
    def test_basic_trigonometric(self, shared_devices, operation, shape):
    ...
    @pytest.mark.fast
    def test_inverse_trigonometric(self, shared_devices, operation, shape):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_hyperbolic_functions(self, shared_devices, operation, shape):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_atan2(self, shared_devices):
        device = shared_devices["t4"]
...
class TestExponentialLogarithmicOperations:
    ...
    @pytest.mark.fast
    def test_exponential_functions(self, shared_devices, operation, shape):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_logarithmic_functions(self, shared_devices, operation, shape):
        device = shared_devices["t4"]
    ...
    @pytest.mark.parametrize("shape", [(8,), (4, 4)])
    @pytest.mark.fast
    def test_power_operations(self, shared_devices, shape):
        device = shared_devices["t4"]

        base_cpu = torch.abs(torch.randn(*shape)) + 0.1  # Positive base
        exp_cpu = torch.randn(*shape) * 2  # Moderate exponents

        base_remote = base_cpu.to(device.device())
        exp_remote = exp_cpu.to(device.device())
...
class TestRootOperations:
    ...
    @pytest.mark.parametrize("shape", [(10,), (5, 5), (2, 3, 4)])
    @pytest.mark.fast
    def test_root_operations(self, shared_devices, operation, shape):
        device = shared_devices["t4"]
...
class TestRoundingOperations:
    ...
    @pytest.mark.fast
    def test_rounding_operations(self, shared_devices, operation, shape):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_frac(self, shared_devices):
        device = shared_devices["t4"]
...
class TestMiscellaneousMathOperations:
    ...
    @pytest.mark.fast
    def test_abs(self, shared_devices, shape):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_clamp(self, shared_devices, shape):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_sign(self, shared_devices, shape):
        device = shared_devices["t4"]
...
class TestMathOperationsWithGradients:
    ...
    @pytest.mark.fast
    def test_math_operations_with_gradients(self, shared_devices, operation):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_complex_math_expression_with_gradients(self, shared_devices):
        device = shared_devices["t4"]
...
class TestMathOperationsEdgeCases:
    ...
    @pytest.mark.fast
    def test_operations_with_special_values(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_operations_with_zero_tensors(self, shared_devices):
        device = shared_devices["t4"]

        cpu_zeros = torch.zeros(3, 3)
        remote_zeros = cpu_zeros.to(device.device())
    ...
    @pytest.mark.fast
    def test_operations_with_single_element_tensors(self, shared_devices):
        device = shared_devices["t4"]
        ...
        for operation in ["sin", "exp", "log", "sqrt", "abs"]:
            ...
            cpu_test = test_val
            remote_test = test_val.to(device.device())
