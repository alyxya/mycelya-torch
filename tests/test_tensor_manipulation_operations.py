...
class TestSplittingOperations:
    ...
    @pytest.mark.fast
    def test_split_operations(self, shared_devices, split_size, dim):
    ...
    @pytest.mark.fast
    def test_chunk_operations(self, shared_devices, num_chunks, dim):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_split_with_list_sizes(self, shared_devices):
        device = shared_devices["t4"]
...
class TestStackingOperations:
    ...
    @pytest.mark.fast
    def test_stack_operations(self, shared_devices, dim):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_hstack_operations(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_vstack_operations(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_dstack_operations(self, shared_devices):
        device = shared_devices["t4"]
...
class TestRepeatAndTileOperations:
    ...
    @pytest.mark.fast
    def test_repeat_operations(self, shared_devices, repeats):
        device = shared_devices["t4"]
    ...
    @pytest.mark.parametrize("dim", [0, 1])
    @pytest.mark.fast
    def test_repeat_interleave_operations(self, shared_devices, repeats, dim):
        device = shared_devices["t4"]
    ...
    def test_repeat_interleave_with_tensor_repeats(self, shared_devices):
        ...
        remote_repeats = cpu_repeats.to(device.device())
    ...
    @pytest.mark.fast
    def test_tile_operations(self, shared_devices, tiles):
        device = shared_devices["t4"]
...
class TestSortingOperations:
    ...
    @pytest.mark.fast
    def test_sort_operations(self, shared_devices, dim, descending):
        device = shared_devices["t4"]
    ...
    @pytest.mark.parametrize("descending", [False, True])
    @pytest.mark.fast
    def test_argsort_operations(self, shared_devices, dim, descending):
        device = shared_devices["t4"]
    ...
    @pytest.mark.parametrize("dim", [0, 1])
    @pytest.mark.fast
    def test_topk_operations(self, shared_devices, k, dim):
        device = shared_devices["t4"]
    ...
    @pytest.mark.parametrize("dim", [0, 1])
    @pytest.mark.fast
    def test_kthvalue_operations(self, shared_devices, k, dim):
        device = shared_devices["t4"]
...
class TestPaddingOperations:
    ...
    @pytest.mark.fast
    def test_constant_pad_with_value(self, shared_devices, pad, value):
        device = shared_devices["t4"]
...
class TestReshapingOperations:
    ...
    @pytest.mark.fast
    def test_expand_operations(self, shared_devices, size):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_expand_as_operations(self, shared_devices):
        device = shared_devices["t4"]

        cpu_tensor = torch.randn(1, 4)
        cpu_other = torch.randn(3, 4)
        remote_tensor = cpu_tensor.to(device.device())
        remote_other = cpu_other.to(device.device())
    ...
    @pytest.mark.fast
    def test_narrow_operations(self, shared_devices, start, length):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_unfold_operations(self, shared_devices, dimension, size, step):
        device = shared_devices["t4"]
...
class TestTensorManipulationWithGradients:
    ...
    @pytest.mark.fast
    def test_split_with_gradients(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_stack_with_gradients(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_repeat_with_gradients(self, shared_devices):
        device = shared_devices["t4"]
...
class TestTensorManipulationEdgeCases:
    ...
    @pytest.mark.fast
    def test_empty_tensor_operations(self, shared_devices):
        device = shared_devices["t4"]

        cpu_empty = torch.empty(0, 5)
        remote_empty = cpu_empty.to(device.device())
    ...
    @pytest.mark.fast
    def test_single_element_operations(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_large_dimension_operations(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_mixed_dimension_stacking(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_dtype_preservation(self, shared_devices):
        device = shared_devices["t4"]
