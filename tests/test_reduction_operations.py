...
class TestMinMaxOperations:
    ...
    @pytest.mark.fast
    def test_aminmax(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_aminmax_with_dim(self, shared_devices, dim):
        device = shared_devices["t4"]
...
class TestCumulativeOperations:
    ...
    @pytest.mark.parametrize("shape", [(8,), (4, 4), (2, 3)])
    @pytest.mark.parametrize("dim", [0, 1, -1])
    @pytest.mark.fast
...
class TestSpecializedReductions:
    ...
    @pytest.mark.fast
    def test_logsumexp(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.parametrize("keepdim", [False, True])
    @pytest.mark.fast
    def test_logsumexp_with_dim(self, shared_devices, dim, keepdim):
        device = shared_devices["t4"]
...
class TestReductionEdgeCases:
    ...
    @pytest.mark.fast
    def test_reductions_with_single_element(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_reductions_with_zeros(self, shared_devices):
        device = shared_devices["t4"]
    ...
    @pytest.mark.fast
    def test_reductions_preserve_dtype(self, shared_devices):
        device = shared_devices["t4"]

        # Test with integer tensor
        cpu_int_tensor = torch.randint(0, 10, (3, 3), dtype=torch.int32)
        remote_int_tensor = cpu_int_tensor.to(device.device())
