...
def __adaptive_avg_pool2d_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten._adaptive_avg_pool2d.out, *args, **kwargs
    )
...
def __adaptive_avg_pool2d_backward_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten._adaptive_avg_pool2d_backward, *args, **kwargs
    )
...
def __adaptive_avg_pool2d_backward_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten._adaptive_avg_pool2d_backward.out, *args, **kwargs
    )
...
def __adaptive_avg_pool3d_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten._adaptive_avg_pool3d.out, *args, **kwargs
    )
...
def __native_batch_norm_legit_no_stats_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten._native_batch_norm_legit.no_stats_out, *args, **kwargs
    )
...
def __native_batch_norm_legit_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten._native_batch_norm_legit.out, *args, **kwargs
    )
...
def __native_batch_norm_legit_no_training_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten._native_batch_norm_legit_no_training.out, *args, **kwargs
    )
...
def _adaptive_avg_pool1d_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.adaptive_avg_pool1d.out, *args, **kwargs
    )
...
def _bitwise_and_Scalar_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.bitwise_and.Scalar_out, *args, **kwargs
    )
...
def _bitwise_and_Tensor_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.bitwise_and.Tensor_out, *args, **kwargs
    )
...
def _bitwise_or_Scalar_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.bitwise_or.Scalar_out, *args, **kwargs
    )
...
def _bitwise_or_Tensor_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.bitwise_or.Tensor_out, *args, **kwargs
    )
...
def _bitwise_xor_Scalar_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.bitwise_xor.Scalar_out, *args, **kwargs
    )
...
def _bitwise_xor_Tensor_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.bitwise_xor.Tensor_out, *args, **kwargs
    )
...
def _convolution_backward_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.convolution_backward.out, *args, **kwargs
    )
...
def _embedding_dense_backward_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.embedding_dense_backward, *args, **kwargs
    )
...
def _embedding_dense_backward_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.embedding_dense_backward.out, *args, **kwargs
    )
...
def _max_pool2d_with_indices_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.max_pool2d_with_indices, *args, **kwargs
    )
...
def _max_pool2d_with_indices_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.max_pool2d_with_indices.out, *args, **kwargs
    )
...
def _max_pool2d_with_indices_backward_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.max_pool2d_with_indices_backward, *args, **kwargs
    )
...
def _max_pool3d_with_indices_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.max_pool3d_with_indices, *args, **kwargs
    )
...
def _max_pool3d_with_indices_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.max_pool3d_with_indices.out, *args, **kwargs
    )
...
def _native_group_norm_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.native_group_norm.out, *args, **kwargs
    )
...
def _native_group_norm_backward_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.native_group_norm_backward, *args, **kwargs
    )
...
def _native_group_norm_backward_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.native_group_norm_backward.out, *args, **kwargs
    )
...
def _native_layer_norm_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.native_layer_norm.out, *args, **kwargs
    )
...
def _native_layer_norm_backward_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.native_layer_norm_backward, *args, **kwargs
    )
...
def _native_layer_norm_backward_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.native_layer_norm_backward.out, *args, **kwargs
    )
...
def _pow_Tensor_Scalar_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.pow.Tensor_Scalar_out, *args, **kwargs
    )
...
def _pow_Tensor_Tensor_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.pow.Tensor_Tensor_out, *args, **kwargs
    )
...
def _replication_pad2d_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.replication_pad2d.out, *args, **kwargs
    )
...
def _replication_pad3d_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.replication_pad3d.out, *args, **kwargs
    )
...
def _scatter_reduce_two_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.scatter_reduce.two_out, *args, **kwargs
    )
...
def _upsample_bilinear2d_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.upsample_bilinear2d.out, *args, **kwargs
    )
...
def _upsample_bilinear2d_vec_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.upsample_bilinear2d.vec, *args, **kwargs
    )
...
def _upsample_bilinear2d_vec_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.upsample_bilinear2d.vec_out, *args, **kwargs
    )
...
def _upsample_nearest2d_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.upsample_nearest2d.out, *args, **kwargs
    )
...
def _upsample_nearest2d_vec_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.upsample_nearest2d.vec, *args, **kwargs
    )
...
def _upsample_nearest2d_vec_out_wrapper(*args, **kwargs):
    ...
    return _remote_kernel_fallback(
        torch.ops.aten.upsample_nearest2d.vec_out, *args, **kwargs
    )
...
_mycelya_lib_aten.impl(
    "_adaptive_avg_pool2d", __adaptive_avg_pool2d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_adaptive_avg_pool2d.out",
    __adaptive_avg_pool2d_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_adaptive_avg_pool2d_backward",
    __adaptive_avg_pool2d_backward_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_adaptive_avg_pool2d_backward.out",
    __adaptive_avg_pool2d_backward_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_adaptive_avg_pool3d", __adaptive_avg_pool3d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_adaptive_avg_pool3d.out",
    __adaptive_avg_pool3d_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_cdist_forward", __cdist_forward_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_cdist_forward.out", __cdist_forward_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_embedding_bag", __embedding_bag_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_embedding_bag.out", __embedding_bag_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("_fft_r2c", __fft_r2c_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "_fft_r2c.out", __fft_r2c_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_log_softmax", __log_softmax_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_log_softmax.out", __log_softmax_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_native_batch_norm_legit",
    __native_batch_norm_legit_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_native_batch_norm_legit.no_stats",
    __native_batch_norm_legit_no_stats_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_native_batch_norm_legit.no_stats_out",
    __native_batch_norm_legit_no_stats_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_native_batch_norm_legit.out",
    __native_batch_norm_legit_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_native_batch_norm_legit_no_training",
    __native_batch_norm_legit_no_training_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_native_batch_norm_legit_no_training.out",
    __native_batch_norm_legit_no_training_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "_pdist_forward", __pdist_forward_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "_pdist_forward.out", __pdist_forward_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("_softmax", __softmax_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "_softmax.out", __softmax_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "adaptive_avg_pool1d", _adaptive_avg_pool1d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "adaptive_avg_pool1d.out",
    _adaptive_avg_pool1d_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl("add.Scalar", _add_Scalar_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "add.Scalar_out", _add_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "any.dims_out", _any_dims_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "arange.start_step", _arange_start_step_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "avg_pool1d.out", _avg_pool1d_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("avg_pool2d", _avg_pool2d_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "avg_pool2d.out", _avg_pool2d_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "avg_pool2d_backward", _avg_pool2d_backward_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("avg_pool3d", _avg_pool3d_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "avg_pool3d.out", _avg_pool3d_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_and.Scalar", _bitwise_and_Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_and.Scalar_out",
    _bitwise_and_Scalar_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "bitwise_and.Tensor", _bitwise_and_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_and.Tensor_out",
    _bitwise_and_Tensor_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "bitwise_and_.Scalar", _bitwise_and__Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_and_.Tensor", _bitwise_and__Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("bitwise_not", _bitwise_not_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "bitwise_not.out", _bitwise_not_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_not_", _bitwise_not__wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_or.Scalar", _bitwise_or_Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_or.Scalar_out", _bitwise_or_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_or.Tensor", _bitwise_or_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_or.Tensor_out", _bitwise_or_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_or_.Scalar", _bitwise_or__Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_or_.Tensor", _bitwise_or__Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_xor.Scalar", _bitwise_xor_Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_xor.Scalar_out",
    _bitwise_xor_Scalar_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "bitwise_xor.Tensor", _bitwise_xor_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_xor.Tensor_out",
    _bitwise_xor_Tensor_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "bitwise_xor_.Scalar", _bitwise_xor__Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "bitwise_xor_.Tensor", _bitwise_xor__Tensor_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "clamp.Tensor", _clamp_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "clamp.Tensor_out", _clamp_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "clamp_.Tensor", _clamp__Tensor_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "constant_pad_nd", _constant_pad_nd_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "constant_pad_nd.out", _constant_pad_nd_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("convolution", _convolution_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "convolution.out", _convolution_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "convolution_backward", _convolution_backward_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "convolution_backward.out",
    _convolution_backward_out_wrapper,
    dispatch_key="PrivateUse1",
)
...
_mycelya_lib_aten.impl(
    "div.Scalar_mode", _div_Scalar_mode_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "div.Scalar_mode_out", _div_Scalar_mode_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "div.Scalar_out", _div_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("div.Tensor", _div_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "div.Tensor_mode", _div_Tensor_mode_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "div_.Scalar_mode", _div__Scalar_mode_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("div_.Tensor", _div__Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "div_.Tensor_mode", _div__Tensor_mode_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "embedding.out", _embedding_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "embedding_dense_backward",
    _embedding_dense_backward_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "embedding_dense_backward.out",
    _embedding_dense_backward_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl("eq.Scalar", _eq_Scalar_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "eq.Scalar_out", _eq_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("eq.Tensor", _eq_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "eq.Tensor_out", _eq_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "fill.Scalar_out", _fill_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "fill_.Scalar", _fill__Scalar_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "fmod.Scalar_out", _fmod_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("fmod.Tensor", _fmod_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "fmod.Tensor_out", _fmod_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "fmod_.Scalar", _fmod__Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "fmod_.Tensor", _fmod__Tensor_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "full_like.out", _full_like_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "ge.Scalar_out", _ge_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("ge.Tensor", _ge_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "ge.Tensor_out", _ge_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "grid_sampler_2d", _grid_sampler_2d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "grid_sampler_2d.out", _grid_sampler_2d_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("gt.Scalar", _gt_Scalar_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "gt.Scalar_out", _gt_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("gt.Tensor", _gt_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "gt.Tensor_out", _gt_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "hardtanh.out", _hardtanh_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("hardtanh_", _hardtanh__wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "index.Tensor", _index_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "index.Tensor_out", _index_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("index_put", _index_put_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "index_put.out", _index_put_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("index_put_", _index_put__wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "index_select", _index_select_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "index_select.out", _index_select_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "le.Scalar_out", _le_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("le.Tensor", _le_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "le.Tensor_out", _le_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "leaky_relu.out", _leaky_relu_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "logical_and.out", _logical_and_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "logical_and_", _logical_and__wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("logical_not", _logical_not_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "logical_not.out", _logical_not_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "logical_not_", _logical_not__wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("logical_or", _logical_or_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "logical_or.out", _logical_or_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "logical_xor.out", _logical_xor_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "logical_xor_", _logical_xor__wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("lt.Scalar", _lt_Scalar_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "lt.Scalar_out", _lt_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("lt.Tensor", _lt_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "lt.Tensor_out", _lt_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "masked_scatter", _masked_scatter_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "masked_scatter.out", _masked_scatter_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "masked_scatter_", _masked_scatter__wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    ...
    _max_pool2d_with_indices_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "max_pool2d_with_indices.out",
    _max_pool2d_with_indices_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "max_pool2d_with_indices_backward",
    _max_pool2d_with_indices_backward_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "max_pool3d_with_indices",
    _max_pool3d_with_indices_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "max_pool3d_with_indices.out",
    _max_pool3d_with_indices_out_wrapper,
    dispatch_key="PrivateUse1",
)
...
_mycelya_lib_aten.impl(
    "mul.Scalar_out", _mul_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "native_dropout", _native_dropout_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "native_dropout.out", _native_dropout_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "native_group_norm", _native_group_norm_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "native_group_norm.out", _native_group_norm_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "native_group_norm_backward",
    _native_group_norm_backward_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "native_group_norm_backward.out",
    _native_group_norm_backward_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "native_layer_norm", _native_layer_norm_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "native_layer_norm.out", _native_layer_norm_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "native_layer_norm_backward",
    _native_layer_norm_backward_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "native_layer_norm_backward.out",
    _native_layer_norm_backward_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl("ne.Scalar", _ne_Scalar_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "ne.Scalar_out", _ne_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("ne.Tensor", _ne_Tensor_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "ne.Tensor_out", _ne_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "pow.Scalar_out", _pow_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "pow.Tensor_Scalar", _pow_Tensor_Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "pow.Tensor_Scalar_out", _pow_Tensor_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "pow.Tensor_Tensor", _pow_Tensor_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "pow.Tensor_Tensor_out", _pow_Tensor_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "prod.dim_int", _prod_dim_int_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "randperm.out", _randperm_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("reciprocal", _reciprocal_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "reciprocal.out", _reciprocal_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("reciprocal_", _reciprocal__wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "reflection_pad1d", _reflection_pad1d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "reflection_pad1d.out", _reflection_pad1d_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "reflection_pad2d", _reflection_pad2d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "reflection_pad2d.out", _reflection_pad2d_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "reflection_pad3d", _reflection_pad3d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "reflection_pad3d.out", _reflection_pad3d_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "remainder.Scalar", _remainder_Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "remainder.Scalar_out", _remainder_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "remainder.Tensor", _remainder_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "remainder.Tensor_out", _remainder_Tensor_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "remainder_.Scalar", _remainder__Scalar_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "remainder_.Tensor", _remainder__Tensor_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "replication_pad2d", _replication_pad2d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "replication_pad2d.out", _replication_pad2d_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "replication_pad3d", _replication_pad3d_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "replication_pad3d.out", _replication_pad3d_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "scalar_tensor", _scalar_tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scalar_tensor.out", _scalar_tensor_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("scatter.src", _scatter_src_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "scatter.src_out", _scatter_src_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scatter.value", _scatter_value_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scatter.value_out", _scatter_value_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scatter_.src", _scatter__src_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scatter_.value", _scatter__value_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("scatter_add", _scatter_add_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "scatter_add.out", _scatter_add_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scatter_add_", _scatter_add__wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scatter_reduce.two", _scatter_reduce_two_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "scatter_reduce.two_out",
    _scatter_reduce_two_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "scatter_reduce_.two", _scatter_reduce__two_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("select.int", _select_int_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "select_scatter", _select_scatter_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "select_scatter.out", _select_scatter_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "slice.Tensor", _slice_Tensor_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "slice_scatter", _slice_scatter_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "slice_scatter.out", _slice_scatter_out_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("sort", _sort_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "split_with_sizes", _split_with_sizes_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "squeeze.dims", _squeeze_dims_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "squeeze_.dim", _squeeze__dim_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "squeeze_.dims", _squeeze__dims_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl("sub.Scalar", _sub_Scalar_wrapper, dispatch_key="PrivateUse1")
_mycelya_lib_aten.impl(
    "sub.Scalar_out", _sub_Scalar_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "sum.dim_IntList", _sum_dim_IntList_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    ...
    _upsample_bilinear2d_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "upsample_bilinear2d.vec",
    _upsample_bilinear2d_vec_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "upsample_bilinear2d.vec_out",
    _upsample_bilinear2d_vec_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "upsample_nearest2d.out",
    _upsample_nearest2d_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "upsample_nearest2d.vec",
    _upsample_nearest2d_vec_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "upsample_nearest2d.vec_out",
    _upsample_nearest2d_vec_out_wrapper,
    dispatch_key="PrivateUse1",
)
_mycelya_lib_aten.impl(
    "var.correction", _var_correction_wrapper, dispatch_key="PrivateUse1"
)
_mycelya_lib_aten.impl(
    "var.correction_out", _var_correction_out_wrapper, dispatch_key="PrivateUse1"
)
...
_mycelya_lib_aten.impl(
    "where.self_out", _where_self_out_wrapper, dispatch_key="PrivateUse1"
)
